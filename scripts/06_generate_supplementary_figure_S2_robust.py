# ============================================================
# AIDO-h-Biology II | Generate Supplementary Figure S2
...
#
# Figure:
#   Supplementary Figure S2. Term-level prioritization after random calibration
# ============================================================
...
def make_figure_5():
    ...
    fig.suptitle(
        "Supplementary Figure S2. Term-level prioritization after random-baseline calibration",
        y=0.98,
        fontsize=17,
        fontweight="bold"
    )
