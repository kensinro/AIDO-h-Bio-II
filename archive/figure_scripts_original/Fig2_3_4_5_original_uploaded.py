# ============================================================
# AIDO-h-Biology II | Main manuscript figures 2-5
...
# 0. User paths
# -----------------------------
MAIN_ROOT = Path(r"D:/AIDO-Temp/AIDO-h-Biology-II-AllCancers-MultiDB")
...
def make_figure_2():
    ...
    ax.invert_yaxis()
    ax.set_xlabel("Number of cancer-database-term observations")
    ...
    ax.set_ylabel("Number of cancer-database-term observations")
...
# ============================================================
# Figure 5. Term-level prioritization
# ============================================================
...
def make_figure_5():
    ...
    fig.suptitle("Figure 5. Term-level prioritization after random-baseline calibration",
                 y=0.98, fontsize=17, fontweight="bold")
...
if __name__ == "__main__":
    ...
    print("\nDone. Manuscript figures saved to:")
    print(OUT_DIR)
